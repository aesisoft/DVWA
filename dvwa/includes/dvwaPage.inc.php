...
function dvwaHtmlEcho( $pPage ) {
	...
	if( dvwaIsLoggedIn() ) {
		...
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'sqli', 'name' => '1. SQL Injection', 'url' => 'vulnerabilities/sqli/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'sqli_blind', 'name' => '1. SQL Injection (Blind)', 'url' => 'vulnerabilities/sqli_blind/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'fi', 'name' => '1. File Inclusion', 'url' => 'vulnerabilities/fi/.?page=include.php' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'upload', 'name' => '1. File Upload', 'url' => 'vulnerabilities/upload/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'brute', 'name' => '2. Brute Force', 'url' => 'vulnerabilities/brute/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'xxe', 'name' => '4. XXE', 'url' => 'vulnerabilities/xxe/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'insecurein', 'name' => '5. Insecure Input', 'url' => 'vulnerabilities/insecurein/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'mass_assignment', 'name' => '5. Massive Assignement', 'url' => 'vulnerabilities/mass_assignment/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'xss_s', 'name' => '7. XSS (Stored)', 'url' => 'vulnerabilities/xss_s/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'xss_r', 'name' => '7. XSS (Reflected)', 'url' => 'vulnerabilities/xss_r/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'xss_d', 'name' => '7. XSS (DOM)', 'url' => 'vulnerabilities/xss_d/' );
	}
