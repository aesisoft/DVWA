<div class="body_padded">
	...
	<td><div id="code">
		...
		<h3>Objective</h3>
		<p>Modifiy the total price of order</p>
	...
	<p>Reference: <?php echo dvwaExternalLinkUrlGet( 'https://owasp.org/www-project-top-ten/OWASP_Top_Ten_2017/Top_10-2017_A5-Broken_Access_Control' ); ?></p>
</div>
